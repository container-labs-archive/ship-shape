            ...
            <Card className={classes.root} key={rowKey} >
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={4}>
                  ...
                  <Typography variant="body2" component="p">
                    {row.estimated_delivery_date && row.estimated_delivery_date}
                    {!row.estimated_delivery_date && "No Information"}
                  </Typography>
                </Grid>
              </Grid>
              </CardContent>
